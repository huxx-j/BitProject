						...
						<div class="row">
							<!-- 카테고리영역 -->
								...
								<ul class="nav nav-tabs">
									<li class="active"><a data-toggle="tab" href="#packageView_tab_1">카테고리</a></li>
									<li><a data-toggle="tab" href="#packageView_tab_2">검색</a></li>
								</ul>
								<div class = "tab-content">
									<div class = "tab-pane active" id = "packageView_tab_1">
										<div class="scroll">
											<br>
											<br>
											<br>
